  ...
  return (
    ...
    <div className="mx-8 border border-[#d1d7db] rounded-md px-10 pt-7 pb-6 mb-6 -mt-6">
      <div className="flex justify-between items-center">
        ...
        <div>
          <button className='bg-[#008069] text-white font-semibold h-[38px] w-[125px] flex justify-center items-center text-sm rounded-full '>Get the app</button>
        </div>
      </div>
    </div>
