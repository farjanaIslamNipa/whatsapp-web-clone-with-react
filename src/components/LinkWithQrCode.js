  ...
  return (
    ...
    <div className="flex flex-col 2md:flex-row w-full justify-between pb-8 2md:pb-10 border-b border-gray-200">
      <div className="max-w-[556px]">
        ...
        <ol className="pt-7 list-decimal space-y-[18px] list-outside pl-6">
          <li className='text-base slg:text-[18px] leading-7 text-primary font-primaryFont'>Open WhatsApp on your phone</li>
          <li className='text-base slg:text-[18px] leading-7 text-primary font-primaryFont'>
          ...
          <li className='text-base slg:text-[18px] leading-7 text-primary font-primaryFont'>Tap <strong>Linked devices</strong> and then <strong>Link a device</strong></li>
          <li className='text-base slg:text-[18px] leading-7 text-primary font-primaryFont'>Point your phone to this screen to capture the QR code</li>
        </ol>
      </div>
      <div className="ml-0 2md:ml-[60px]">
        <div style={{ background: 'white', height: '264px', width: '264px' }} className='mx-auto mt-10 2md:mt-0'>
            <QRCode
            size={244}
            value="https://github.com/gcoro/react-qrcode-logo"
            logoImage={"/images/whatsapp.png"} />
        </div>
      </div>
    </div>
